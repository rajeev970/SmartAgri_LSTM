// Comprehensive list of Indian districts by state
// Source: Official government data and census information
...
export const stateDistricts = {
  ...
  'Andhra Pradesh': [
    ...
    'West Godavari', 'YSR Kadapa', 'Annamayya', 'Alluri Sitharama Raju', 'Bapatla', 
    'Eluru', 'Kakinada', 'Konaseema', 'NTR', 'Palnadu', 'Parvathipuram Manyam', 
    'Sri Potti Sriramulu Nellore', 'Sri Sathya Sai', 'Tirupati'
  ],

  'Arunachal Pradesh': [
    'All districts', 'Anjaw', 'Changlang', 'Dibang Valley', 'East Kameng', 'East Siang', 
  ...
  'Delhi': [
    'All districts', 'Central Delhi', 'East Delhi', 'New Delhi', 'North Delhi', 
  ...
  'Meghalaya': [
    'All districts', 'East Garo Hills', 'East Jaintia Hills', 'East Khasi Hills', 'North Garo Hills', 
    'Ri Bhoi', 'South Garo Hills', 'South West Garo Hills', 'South West Khasi Hills', 'West Garo Hills', 
    'West Jaintia Hills', 'West Khasi Hills'
  ],

  'Mizoram': [
    'All districts', 'Aizawl', 'Champhai', 'Hnahthial', 'Khawzawl', 'Kolasib', 'Lawngtlai', 
    'Lunglei', 'Mamit', 'Saiha', 'Saitual', 'Serchhip'
  ],

  'Nagaland': [
    'All districts', 'Dimapur', 'Kiphire', 'Kohima', 'Longleng', 'Mokokchung', 'Mon', 'Peren', 
  ...
  'Punjab': [
    'All districts', 'Amritsar', 'Barnala', 'Bathinda', 'Faridkot', 'Fatehgarh Sahib', 'Fazilka', 
    'Ferozepur', 'Gurdaspur', 'Hoshiarpur', 'Jalandhar', 'Kapurthala', 'Ludhiana', 'Mansa', 
  ...
  'Tripura': [
    'All districts', 'Dhalai', 'Gomati', 'Khowai', 'North Tripura', 'Sepahijala', 'South Tripura', 
  ...
  'Puducherry': [
    'All districts', 'Karaikal', 'Mahe', 'Puducherry', 'Yanam'
  ],

  'Ladakh': [
    'All districts', 'Kargil', 'Leh'
  ],

  'Jammu and Kashmir': [
    'All districts', 'Anantnag', 'Bandipora', 'Baramulla', 'Budgam', 'Doda', 'Ganderbal', 
...
export const getDistrictsForState = (state) => {
  return stateDistricts[state] || ['All districts'];
};

// Helper function to get all states
export const getAllStates = () => {
  return Object.keys(stateDistricts).filter(state => state !== 'All India');
};

// Helper function to check if a district exists in a state
export const isDistrictInState = (state, district) => {
